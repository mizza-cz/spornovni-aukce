(function () {
  ...
  function init() {
    const buttons = document.querySelectorAll(".auctionHistory__btn");
    ...
    buttons.forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        if (
          !detailsRow ||
          !detailsRow.classList.contains("auction-history-details")
        ) {
          return;
        }

        document.querySelectorAll(".auction-history-details").forEach((row) => {
          if (row !== detailsRow) {
            ...
            if (parentTr) {
              ...
              const btnInRow = parentTr.querySelector(".auctionHistory__btn");
